...
test('Markdown editor toolbar records microphone audio with Local-First IndexedDB, Recording HUD, live timer, and deferred 888box upload on publish/sync', () => {
    ...
    assert.match(baseSource, /cf-notepad-block-insert-audio/)
    ...
    assert.match(toolbarSource, /initRecordingController/)
    assert.match(toolbarSource, /cf-notepad-start-record/)
