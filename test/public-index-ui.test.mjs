...
test('footer exposes AI format and edit controls for whole-note assistance', () => {
    ...
    assert.match(baseTemplateSource, /const selectionEnd = isEdit \? \$textarea\.selectionEnd : 0/)
    assert.match(baseTemplateSource, /body: JSON\.stringify\(\{ text: rawText, mode, instruction, selectionStart, selectionEnd \}\)/)
