...
test('editor toolbar exposes AI controls without duplicating them in the footer', () => {
    ...
    assert.match(baseTemplateSource, /const selectionStart = supportsSelection \? \$textarea\.selectionStart : 0/)
    assert.match(baseTemplateSource, /const selectionEnd = supportsSelection \? \$textarea\.selectionEnd : 0/)
