...
export function mountCanvasEditor(targetRoot = document.querySelector('#canvas-editor'), targetSource = document.querySelector('#contents'), { isEdit = true } = {}) {
    if (!targetRoot || !targetSource) throw new Error('Canvas editor requires #canvas-editor and #contents')
    const reactRoot = createRoot(targetRoot)
