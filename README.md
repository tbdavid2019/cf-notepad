...
- **Markdown Editor Toolbar**: Editable Markdown notes include headings, emphasis, strikethrough, links, quotes, lists, task lists, inline code, code blocks, horizontal rules, tables, image insertion, fullscreen editing, Undo / Redo, and AI formatting. Labels and placeholders follow the selected interface language.
