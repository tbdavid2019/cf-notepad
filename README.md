...
- **四軌筆記格式與建立入口 (Markdown / Block / Canvas / Whiteboard)**：Footer 最左側的「＋ 新增」選單支援建立 [Markdown 筆記](/new/markdown)、[Block 筆記](/new/block)、[Canvas 畫布](/new/canvas) 或 [Excalidraw 白板](/new/whiteboard)。建立後格式鎖定；Markdown 專注線性純文字排版，Block 提供 Notion 風格區塊操作，Canvas 專注 2D 空間卡片與關係線，Whiteboard 則提供自由手繪草圖、塗鴉與便籤。
