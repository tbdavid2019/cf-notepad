        ...
        ${isEdit ? `
            ...
            ` : (path ? `
                <div class="share-footer-actions">
                    <a href="/${path}" class="opt-button" style="text-decoration:none;background:#2196f3;color:white;padding:6px 16px;border-radius:4px;font-weight:500;">✏️ ${t.backToEdit}</a>
