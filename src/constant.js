...
export const SUPPORTED_LANG = {
    'en-US': {
        ...
        importAudioMarkdown: 'Import audio (verbatim transcript)',
        importAudioDiarizeMarkdown: 'Import audio (AI speaker diarization)',
        importWebsiteMarkdown: 'Import website (creates a Markdown note)',
        importFileBlock: 'Import file (convert to blocks)',
        importAudioBlock: 'Import audio (verbatim to blocks)',
        importAudioDiarizeBlock: 'Import audio (AI diarization to blocks)',
        ...
        transcribingAudio: 'Transcribing audio verbatim with AI (Whisper)...',
        transcribingAudioDiarize: 'Transcribing audio and identifying speakers with AI...',
    ...
    'zh-TW': {
        ...
        importMarkdown: '匯入 Office / PDF / 音訊 (逐字稿) / Markdown 檔案',
        importFileMarkdown: '匯入檔案（建立 Markdown 筆記）',
        importAudioMarkdown: '匯入音訊（純逐字稿 Whisper）',
        importAudioDiarizeMarkdown: '匯入音訊（AI 區分發言者）',
        importWebsiteMarkdown: '匯入網站（建立 Markdown 筆記）',
        importFileBlock: '匯入檔案（轉成 Block）',
        importAudioBlock: '匯入音訊（純逐字稿轉 Block）',
        importAudioDiarizeBlock: '匯入音訊（AI 區分發言者轉 Block）',
        ...
        transcribingAudio: '正在使用 AI (Whisper) 轉錄音訊為純逐字稿...',
        transcribingAudioDiarize: '正在轉錄音訊並由 AI 辨識發言者...',
