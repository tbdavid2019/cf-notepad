...
export const SUPPORTED_LANG = {
    'en-US': {
        ...
        burnAfterReadingHint: 'The public share is destroyed after the view limit; the original note remains in the wiki.',
    ...
    'zh-TW': {
        ...
        burnAfterReadingHint: '公開分享達到瀏覽上限後會銷毀；作者原始筆記仍保留。',
