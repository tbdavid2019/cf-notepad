...
export const SUPPORTED_LANG = {
    'en-US': {
        ...
        importAudioMarkdown: 'Import audio to transcript (Whisper AI)',
        importWebsiteMarkdown: 'Import website (creates a Markdown note)',
        importFileBlock: 'Import file (convert to blocks)',
        importAudioBlock: 'Import audio to transcript (convert to blocks)',
        ...
        transcribingAudio: 'Transcribing audio and identifying speakers with AI (Whisper)...',
        markdownImported: 'Markdown imported.',
        documentImported: 'Document converted and imported successfully.',
        audioTranscribed: 'Audio transcript with speaker diarization generated successfully.',
    ...
    'zh-TW': {
        ...
        importAudioMarkdown: '匯入音訊轉逐字稿（Whisper AI）',
        importWebsiteMarkdown: '匯入網站（建立 Markdown 筆記）',
        importFileBlock: '匯入檔案（轉成 Block）',
        importAudioBlock: '匯入音訊轉逐字稿（轉成 Block）',
        ...
        transcribingAudio: '正在使用 AI (Whisper) 轉錄音訊並自動區分發言者...',
        markdownImported: '已導入 Markdown。',
        documentImported: '文件已成功轉換並導入。',
        audioTranscribed: '音訊已成功轉錄並完成發言者區分！',
